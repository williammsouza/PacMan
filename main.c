    ...
    while (!bQuit)
    {
        ...
        else
        {
           ...
           // glRotatef (theta, 0.0f, 0.0f, 1.0f);
            ...
            glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (-0.8f, 0.6f);
            glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (0.8f, 0.6f);
            glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (0.8f, -0.6f);
            glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (-0.8f, -0.6f);
            glEnd ();
            
            glBegin (GL_LINE_LOOP); //Linha Cima
            ...
            glBegin (GL_LINE_LOOP); //Linha Baixo
            glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (-0.75f, -0.55f);
            glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (0.75f, -0.55f);
            glEnd ();
            
           
       		glBegin (GL_LINE_LOOP); //Linha vertical esquerda metade 1
       		  glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (-0.75f, 0.55f);
            ...
            glEnd ();
       		...
       		glBegin (GL_LINE_LOOP); //Linha vertical direita metade 1
       		  glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (0.75f, 0.55f);
        	  glColor3f (1.0f, 1.0f, 0.0f);   glVertex2f (0.75f, 0.1f);           
            glEnd ();
